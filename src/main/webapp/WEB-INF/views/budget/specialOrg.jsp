...
//         if (isLeaf == false) e.showCheckBox = false; //父节点的CheckBox全部隐藏
    ...
    function SetData(data){
        ...
        if(record.action == "edit"){
        	var row = record.row;
        	$.post("${ctx}/portal/budget/special/getOrgTree.json", {budget_special_id: row.budget_special_id}, function(data) {
...
//      var orgs = tree.getValue(true);//false-不包含父节点、true-包含
        ...
        var paramMap = {budget_special_id:record.row.budget_special_id, orgs:orgs.join()};
